      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <div className="prose prose-lg max-w-none text-right" dir="rtl">
            <p className="text-gray-700 leading-relaxed mb-6">
              التصدير في القطاع الصناعي يعد أساساً لتعزيز الاقتصاد الوطني في قطر، ويمثل رؤية قطر 2030 لتحقيق التنوع الاقتصادي وتقليل الاعتماد على الموارد الطبيعية. تسعى دولة قطر إلى تطوير صناعات متنوعة تشمل النفط و الغاز ، و البتروكيماويات، و الصناعات التحويلية، إلى جانب المنتجات الغذائية والتكنولوجية، مما يعزز مكانتها كوجهة صناعية وتجارية عالمية. للمزيد من المعلومات، يمكنكم زيارة موقع بنك قطر للتنمية من خلال الرابط التالي:{' '}
        ...
        <div className="bg-gradient-to-l from-moci-maroon to-moci-lightMaroon text-white rounded-lg p-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            دعونا نُعرّف العالم على منتجاتنا الوطنية التي نفخر بها في قطر، عبر واتساب وتويتر وإنستغرام.
          </h2>
